...
setup(
    ...
    url=about['__url__'],
    packages=['blazer', 'blazer.cli', 'blazer.hpc.mpi.kernel', 'blazer.logs', 'blazer.hpc', 'blazer.hpc.alcf', 'blazer.hpc.gpu', 'blazer.tests', 'blazer.hpc.mpi'],
    ...
    entry_points={
        'console_scripts': ['blazer=blazer.cli:cli']
    },
    classifiers=[
